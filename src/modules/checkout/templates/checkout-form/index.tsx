...
export default async function CheckoutForm({
  ...
  return (
    <div className="relative">
      ...
      <div className="w-full p-4 mb-4 border rounded-md text-center" style={{ backgroundColor: '#C44E4B1A', borderColor: '#C44E4B' }}>
        <p className="font-medium" style={{ color: '#A03E3B' }}>All orders are pickup orders for now.</p>
      </div>
      <div className="w-full grid grid-cols-1 gap-y-2">
        <LocalizedClientLink
          className="flex items-baseline gap-2 text-sm hover:text-neutral-500"
          href="/cart"
          style={{ color: '#C44E4B' }}
        >
          <Button variant="secondary" className="border-current text-current hover:bg-current hover:text-white">
            <UTurnArrowRight />
